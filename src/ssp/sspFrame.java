...
public class sspFrame implements ActionListener, ComponentListener
{
    ...
    public void gameframe()
    {
        ...
        frameIcon = new ImageIcon("design/papier.png");
    ...
    public void finalframe()
    {
        ...
        frame.setLayout(new FlowLayout(FlowLayout.CENTER,0,0));
        frame.setResizable(false);
        frameIcon = new ImageIcon("design/schere.png");
        frame.setIconImage(frameIcon.getImage());
        //------------------------------------------------------
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==button1l2)
        {
            ...
            userinput = 1;
            userIcon = new ImageIcon("design/stein.png");
        ...
        if(e.getSource()==button2l2)
        {
            ...
            userinput = 2;
            userIcon = new ImageIcon("design/papier.png");
            label3_2.setIcon(userIcon);
            comGen();
            checker();
            button1l5.setEnabled(true);
        ...
        if(e.getSource()==button3l2)
        {
            ...
            userinput = 3;
            userIcon = new ImageIcon("design/schere.png");
            label3_2.setIcon(userIcon);
            comGen();
            checker();
            button1l5.setEnabled(true);
    ...
    public void comGen()
    {
        ...
        switch (Cominput)
        {
            case 1:
                Cominput = 1;
                comIcon = new ImageIcon("design/stein.png");
                label3_4.setIcon(comIcon);
                break;

            case 2:
                Cominput = 2;
                comIcon = new ImageIcon("design/papier.png");
                label3_4.setIcon(comIcon);
                break;

            case 3:
                Cominput = 3;
                comIcon = new ImageIcon("design/schere.png");
                label3_4.setIcon(comIcon);
                break;
