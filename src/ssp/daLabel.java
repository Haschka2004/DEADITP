...
public class daLabel implements ActionListener,KeyListener
{
    JFrame mainFrame;
    ...
    sspFrame mainob = new sspFrame();
    sspControl mainob2 = new sspControl();
    ...
    public void GameRunner()
    {
        ...
        mainFrameIcon = new ImageIcon("design/papier.png");
