...
public class sspControl implements ActionListener, KeyListener
{
    JFrame frame;
    JPanel panel1;
    JPanel panel2;
    ...
    public void helpFrame()
    {
        ...
        String texts = "Help\n\nidk i wrote giberrish here but you \nknow the rules dont you so why go for \nthe help also do consider sharing \nthe video please - sanskar songara";
